...
public class CustomRestGlobalExceptionHandling {
    ...
    public ResponseEntity<ApiError> handleResourceNotFound(final DriverNotFoundException ex, final HttpServletRequest request) {
    ...
    public ResponseEntity<ApiError> handleValidation(final DriverValidationException ex, final HttpServletRequest request) {
        final ApiError apiError = new ApiError(
                LocalDateTime.now(Clock.systemUTC()),
